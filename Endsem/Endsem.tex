...
\begin{enumerate}
   ...
   \textbf{Solution:} 
    ...
    %\caption{Plot of decay of the absolute error of $\displaystyle \int_{-1}^{1} e^{-x^2} dx$ with $N \in \{2, 5, 10, 20, 50, 100\}$}
    \end{figure}
    ...
    %\caption{Plot of decay of the absolute error of $\displaystyle \int_{0}^{1} \frac{e^{-x}}{\sqrt{x}} dx$ with $N \in \{5, 10, 20, 50, 100, 200, 500, 1000\}$}
    \end{figure} 
