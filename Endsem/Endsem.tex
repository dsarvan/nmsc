...
\begin{enumerate}
    ...
    If $I_{1},\ I_{2}$ are the values of $I$ with sub-intervals of width $h_{1},\ h_{2}$ and $E_{1},\ E_{2}$ their corresponding errors.

    Since $I = I_{1} + E_{1} = I_{2} + E_{2}$, then $E_{2} - E_{1} = I_{1} - I_{2}$
   ...
   \textbf{Solution:} 
    ...
    \begin{equation*}
    \begin{aligned}
    I &= \int_{0}^{1} \frac{(2y-1) sin(2y-1)}{\sqrt{4y-4y^2}} dy = \sum_{i=0}^{1} a_{i} f(2y_{i} - 1) \hspace{2cm} a_{i} = \int_{0}^{1} l_{i}(2y-1) w(2y-1)\ dy \\
    &= a_{0} f(2y_{0} - 1) + a_{1} f(2y_{1} - 1) \\
    ...
    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/program6.pgf}}
    \end{figure}
    ...
    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/program7.pgf}}
    \end{figure}
    ...
    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program80.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program81.pgf}}
    \end{figure}
    
    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program82.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program83.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program84.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program85.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program86.pgf}}
    \end{figure}
    
    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program87.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program88.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program89.pgf}}
    \end{figure}

    \begin{figure}[ht!]
    \centering
    \resizebox{0.9\linewidth}{!}{\input{Scripts/Program8/program810.pgf}}
    \end{figure}
